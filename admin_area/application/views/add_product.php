    ...
    function delete_img(id,image){
        if(id!=''){
            $.ajax({
                ...
                data : {image:id,product:<?php echo isset($product_id)?$product_id:'a'?>,<?php echo $this->security->get_csrf_token_name(); ?>:'<?php echo $this->security->get_csrf_hash();?>',image_name:image},
