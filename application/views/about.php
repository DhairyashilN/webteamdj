		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 col-sm-3">
					<div class="about-awards-images thumbnail">
						<img src="<?php echo base_url(); ?>assets/images/team/member1.jpg" class="img img-responsive">	
						<p style="color: #000">Dushyant Jadhav</p>		
					</div>
				</div>
				<div class="col-lg-3 col-sm-3">
					<div class="about-awards-images thumbnail">
						<img src="<?php echo base_url(); ?>assets/images/team/member1.jpg" class="img img-responsive">	
						<p style="color: #000">Ashish Jadhav</p>		
					</div>
				</div>
				<div class="col-lg-3 col-sm-3">
					<div class="about-awards-images thumbnail">
						<img src="<?php echo base_url(); ?>assets/images/team/member1.jpg" class="img img-responsive">	
						<p style="color: #000">Nawaj Sheikh</p>		
					</div>
				</div>
				<div class="col-lg-3 col-sm-3">
					<div class="about-awards-images thumbnail">
						<img src="<?php echo base_url(); ?>assets/images/team/member1.jpg" class="img img-responsive">
						<p style="color: #000">Dhairyashil Nalawade</p>		
					</div>
				</div>
			</div>
		</div>
