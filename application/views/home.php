		...
		<div id="carousel-example-generic" class="carousel slide carousel-fade"" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="<?php echo base_url(); ?>assets/images/racing.JPG" class="img img-responsive" alt="..." >
					<div class="carousel-caption">
						<h2>TEAM DJ Racing</h2>
					</div>
				</div>
				<div class="item">
				...
				<div class="item">
					<img src="<?php echo base_url(); ?>assets/images/Pic1_Dushyant-Jadhav-with-MadMax-Fury.jpg" alt="..." class="img img-responsive" >
					<div class="carousel-caption">
						<h2>TEAM DJ Consultation</h2>
					</div>
				</div>
			</div>
			<!-- Controls -->
