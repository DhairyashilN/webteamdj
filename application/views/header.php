...
<html lang="en">
<head>
  <?php $site_data = $this->db->get('site_settings_tbl')->result(); 
  foreach ($site_data as $value) { ?>
  <title><?php echo $value->site_title; ?> | <?php echo !empty($title) ? $title : '' ?></title>
  <meta name="description" content="<?php echo $value->site_meta_desc; ?>">
  <meta name="keywords" content="<?php echo $value->site_meta_keywords; ?>">
  <?php } ?>
  <meta charset="utf-8">
...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top navbar-black">
    <div class="container">
      ...
      <!-- Second Navbar -->
      <nav class="navbar navbar-inverse navbar-fixed-top navbar-black-2" style="display: none">
        <div class="container">
          <!-- Brand and toggle get grouped for better mobile display -->
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/logo.png" class="img img-responsive navbar-black-two-brand"></a>
          </div>
          <!-- Collect the nav links, forms, and other content for toggling -->
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <ul class="nav navbar-nav navbar-right navbar-black-right-2">
              <li><a href="<?php echo base_url();?>" class="<?php if (!empty($title) && ($title == 'Home')) { echo 'active';} ?>">Home</a></li>
              <li><a href="<?php echo site_url('about');?>" class="<?php if (!empty($title) && ($title == 'About')) { echo 'active';} ?>">About</a></li>
              <li><a href="<?php echo site_url('services');?>" class="<?php if (!empty($title) && ($title == 'Services')) { echo 'active';} ?>">Services</a></li>
              <!-- <li><a href="<?php echo site_url('work');?>">Work</a></li> -->
